          ...
          <AnimatePresence mode="wait">
            {tab === 'signin' && (
              <motion.div key="signin" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.25 }} className="space-y-5 relative z-10">
                ...
                <div className="text-center lg:text-left">
                  <h2 className="text-2xl font-bold text-[#f4d0a4] drop-shadow-md">Welcome back</h2>
                  <p className="mt-1 text-sm text-[#b08b68] font-medium tracking-wide">Sign in to continue to your dashboard</p>
                </div>
                ...
                <form onSubmit={handleSignIn} className="space-y-4">
                  <div>
                    <label htmlFor="email" className="block text-sm font-bold text-[#e8c396]">Email address</label>
                  ...
                  <div>
                    <label htmlFor="password" className="block text-sm font-bold text-[#e8c396]">Password</label>
                    <div className="mt-1.5 relative group">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"><span className="text-xl">🗝️</span></div>
                      <input
            ...
            {tab === 'signup' && (
              <motion.div key="signup" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} transition={{ duration: 0.25 }} className="space-y-5 relative z-10">
                ...
                <div className="text-center lg:text-left">
                  <h2 className="text-2xl font-bold text-[#f4d0a4] drop-shadow-md">Create an account</h2>
                  <p className="mt-1 text-sm text-[#b08b68] font-medium tracking-wide">Join the crew and start predicting CLV</p>
                </div>
                ...
                {!registerSuccess && (
                  <form onSubmit={handleSignUp} className="space-y-4">
                    {/* Name */}
                    <div>
                      <label htmlFor="reg-name" className="block text-sm font-bold text-[#e8c396]">Full Name</label>
                    ...
                    {/* Email */}
                    <div>
                      <label htmlFor="reg-email" className="block text-sm font-bold text-[#e8c396]">Email address</label>
                      <div className="mt-1.5 relative">
                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"><span className="text-xl">✉️</span></div>
                        <input
                    ...
                    {/* Password */}
                    <div>
                      <label htmlFor="reg-password" className="block text-sm font-bold text-[#e8c396]">Password <span className="text-[#8b6848] font-normal">(min 8 chars)</span></label>
                      <div className="mt-1.5 relative">
                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"><span className="text-xl">🗝️</span></div>
                        <input
                    ...
                    {/* Confirm Password */}
                    <div>
                      <label htmlFor="reg-confirm" className="block text-sm font-bold text-[#e8c396]">Confirm Password</label>
                      <div className="mt-1.5 relative">
