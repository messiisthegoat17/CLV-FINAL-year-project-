...
const SYSTEM_CONTEXT = `You are a helpful AI assistant for CLV Predictor AI, a Customer Lifetime Value prediction application. 
You help users understand and navigate the application.
...
Be helpful, concise, and friendly. If you don't know something specific about the app, provide general guidance.`;
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-0 right-0 sm:bottom-6 sm:right-6 z-50 w-full sm:w-96 h-full sm:h-[32rem] sm:max-h-[80vh] flex flex-col bg-white dark:bg-slate-900 sm:rounded-2xl shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-700"
          >
            {/* Header */}
